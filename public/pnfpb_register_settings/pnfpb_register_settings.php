...
if ( ! defined( 'ABSPATH' ) ) {
    exit; // Exit if accessed directly
            ...
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_enable", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_enable_on_demand", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_enable_post_editor", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_provider", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_endpoint", $register_settings_args_for_url);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_api_key", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_model", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_max_input_chars", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_share_full_content", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_enable_send_time", $register_settings_args);
            register_setting("pnfpb_icfcm_group_config", "pnfpb_ai_assistant_enable_audience", $register_settings_args);
