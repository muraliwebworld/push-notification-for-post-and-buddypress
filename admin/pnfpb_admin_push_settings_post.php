...
?>
	<tr class="pnfpb_navy_blue_background_color pnfpb_white_text_color pnfpb_section_header_font_16px">
        ...
        <tr class="pnfpb_ic_push_settings_table_row">
			<td class="pnfpb_ic_push_settings_table_column column-columnname">
  					...
  					<div class="pnfpb_column">
    					<div class="pnfpb_card">					
							<b>
								<?php echo esc_html(
									__(
										"For backend post sent from admin post editor, make sure metabox for PNFPB Push notification is switched ON.",
										"push-notification-for-post-and-buddypress"
									)
								); ?>
							</b>
				...
				<div class="pnfpb_row">
    					...
    					<div class="pnfpb_card">				
							<label class="pnfpb_ic_push_settings_table_label_checkbox" 
								   for="pnfpb_ic_fcm_post_enable">
											<?php echo esc_html(
           										__("Frontend post", "push-notification-for-post-and-buddypress")
       										); ?>
							</label>						
					...
					<div class="pnfpb_column">
						<div class="pnfpb_card">
							...
							esc_html(
								__(
									 "Turn on this for all frontend post and turn on/off below post types buttons",
									 "push-notification-for-post-and-buddypress"
								)
							) .
							"</a>"; ?>
				...
				<div class="pnfpb_row  pnfpb_ic_push_settings_table_border_bottom">
        		<?php
          $posttypecount = 0;
          $rowcount = 0;
  				...
  				<div class="pnfpb_row pnfpb_ic_push_settings_table_border_bottom">
    				<div class="pnfpb_column">
						<div class="pnfpb_column">
							<div class="pnfpb_card">				
								<label class="pnfpb_ic_push_settings_table_label_checkbox" 
									   for="<?php echo esc_attr("pnfpb_ic_fcm_default_post_schedule_enable"); ?>">
								...
								<label class="pnfpb_switch">	
									<input id="<?php echo esc_attr("pnfpb_ic_fcm_default_post_schedule_enable"); ?>" 
										   name="<?php echo esc_attr("pnfpb_ic_fcm_default_post_schedule_enable"); ?>" 
										   type="checkbox" value="1" <?php checked(
	"1",
	esc_attr(get_option("pnfpb_ic_fcm_default_post_schedule_enable"))
); ?>  
										   />
									<span class="pnfpb_slider round"></span>
								</label>
						...
						<?php
							if ($post_type !== "buddypress") { ?>
								<div class="pnfpb_column">
									<div class="pnfpb_card">				
										<label class="pnfpb_ic_push_settings_table_label_checkbox" 
											   for="<?php echo esc_attr("pnfpb_ic_fcm_".$labeltext."_post_schedule_enable"); ?>">
											<?php echo esc_html($labeltext); ?>
										</label>
										<label class="pnfpb_switch">	
											<input id="<?php echo esc_attr("pnfpb_ic_fcm_".$post_type."_post_schedule_enable"); ?>" 
												   ...
												   type="checkbox" value="1" <?php checked(
										"1",
										esc_attr(get_option("pnfpb_ic_fcm_" . $post_type . "_post_schedule_enable"))
									); ?>  
												   />
											<span class="pnfpb_slider round"></span>
										</label>
             ...
             '/wp-admin/admin.php?page=pnfpb_icfm_action_scheduler&s=PNFPB_cron_post_hook&action=-1&paged=1&action2=-1" target="_blank">'
				...
				<div class="pnfpb_ic_post_type_content_form">
					<div class="pnfpb_row pnfpb_ic_push_settings_table_border_bottom"></div>
					<div class="pnfpb_row pnfpb_ic_push_settings_table_border_bottom">
						<div class="pnfpb_card">
							<?php
		...
		"push-notification-for-post-and-buddypress"
					...
					<div class="pnfpb_row pnfpb_ic_push_settings_table_border_bottom">
						<div class="pnfpb_column_400">
							<select id="pnfpb_ic_fcm_post_type_followers" 
									name="pnfpb_ic_fcm_post_type_followers" class="pnfpb_margin_top_8">
								<option value="select">
									<?php echo esc_html(__("Select type", "push-notification-for-post-and-buddypress")); ?>
								</option>
								<option value="<?php echo esc_attr("post"); ?>" <?php if (
	get_option("pnfpb_ic_fcm_post_type_followers") === 'post'
) {
	...
	echo "";
								...
								<?php
								if (count($custposttypes) > 0) {
									foreach ($custposttypes as $post_type) {
								?>
								<option value="<?php echo esc_attr($post_type); ?>" <?php if (
									get_option("pnfpb_ic_fcm_post_type_followers") === $post_type
								) {
									echo esc_html("selected");
								} else {
									echo "";
						...
						<div class="pnfpb_column_400">
							<div class="pnfpb_card">
								<?php
								$pnfpb_ic_fcm_only_post_followers_enable = "0";
								if (
									get_option("pnfpb_ic_fcm_only_post_followers_enable") &&
									get_option("pnfpb_ic_fcm_only_post_followers_enable") === "1"
								) {
									$pnfpb_ic_fcm_only_post_followers_enable = "1";
								}
								?>
								<label class="pnfpb_switch">
									<input  id="pnfpb_ic_fcm_only_post_followers_enable" name="pnfpb_ic_fcm_only_post_followers_enable" 
										   type="checkbox" value="1" <?php checked(
	"1",
	esc_attr($pnfpb_ic_fcm_only_post_followers_enable)
); ?>  
										   />
									<span class="pnfpb_slider round"></span>
								</label>							
								<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_fcm_only_post_followers_enable">
									<?php echo esc_html(
	__(
		"Notifications only to followers (requires BuddyPress follow plugin)",
		"push-notification-for-post-and-buddypress"
	)
); ?>
								</label>
					...
					<div class="pnfpb_row pnfpb_ic_push_settings_table_border_bottom">
						<div class="pnfpb_column_400">
							<select id="pnfpb_ic_fcm_post_type_role_based" 
									name="pnfpb_ic_fcm_post_type_role_based" class="pnfpb_margin_top_8">
								<option value="select">
									<?php echo esc_html(__("Select type", "push-notification-for-post-and-buddypress")); ?>
								</option>
								<option value="<?php echo esc_attr("post"); ?>" <?php if (
	get_option("pnfpb_ic_fcm_post_type_role_based") === 'post'
) {
	echo esc_html("selected");
} else {
	echo "";
								...
								?>
								<option value="<?php echo esc_attr($post_type); ?>" <?php if (
									get_option("pnfpb_ic_fcm_post_type_role_based") === $post_type
								) {
									echo esc_html("selected");
								} else {
									echo "";
						...
						<div class="pnfpb_column_400">
							<select id="pnfpb_ic_fcm_select_role_based" 
									name="pnfpb_ic_fcm_select_role_based" class="pnfpb_margin_top_8">
								<option value="select">
									<?php echo esc_html(__("Select Role", "push-notification-for-post-and-buddypress")); ?>
								</option>
								<?php
								if (count($pnfpb_roles) > 0) {
									foreach ($pnfpb_roles as $pnfpb_role) {
								?>
								<option value="<?php echo esc_attr($pnfpb_role); ?>" <?php if (
									get_option("pnfpb_ic_fcm_select_role_based") === $pnfpb_role
								) {
									echo esc_html("selected");
								} else {
									echo "";
								} ?>>
									<?php echo esc_html($pnfpb_role); ?>
								</option>								
								<?php	
									}
								}
						...
						<div class="pnfpb_column_400">
							<div class="pnfpb_card">
								<?php
								$pnfpb_ic_fcm_only_role_based_post_enable = "0";
								if (
									get_option("pnfpb_ic_fcm_only_role_based_post_enable") &&
									get_option("pnfpb_ic_fcm_only_role_based_post_enable") === "1"
								) {
									$pnfpb_ic_fcm_only_role_based_post_enable = "1";
								}
								?>
								<label class="pnfpb_switch">
									<input  id="pnfpb_ic_fcm_only_role_based_post_enable" name="pnfpb_ic_fcm_only_role_based_post_enable" 
										   type="checkbox" value="1" <?php checked(
	"1",
	esc_attr($pnfpb_ic_fcm_only_role_based_post_enable)
); ?>  
										   />
									<span class="pnfpb_slider round"></span>
								</label>							
								<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_fcm_only_role_based_post_enable">
									<?php echo esc_html(
	__(
		"Notifications based on user role who published post/custom post type",
		"push-notification-for-post-and-buddypress"
	)
); ?>
								</label>
