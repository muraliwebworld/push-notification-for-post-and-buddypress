			...
			<div class="pnfpb_row">
				...
				<div class="pnfpb_row">
					...
					<div class="pnfpb_column_400 pnfpb_column_buddypress_functions">
    					<div class="pnfpb_card">
							<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_padding_top_8 pnfpb_max_width_236" 
                            for="pnfpb_ic_fcm_buddypress_follow_enable">
								<?php echo esc_html(
                                    __("BuddyPress follow", "push-notification-for-post-and-buddypress")
                                ); ?>
							</label>
							<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_margin_top_8 pnfpb_margin_left_4 pnfpb_max_width_40">
									<input  id="pnfpb_ic_fcm_buddypress_follow_enable" 
                                            name="pnfpb_ic_fcm_buddypress_follow_enable" 
                                            type="checkbox" value="1" <?php checked(
                                                "1",
                                                esc_attr(get_option("pnfpb_ic_fcm_buddypress_follow_enable"))
                                            ); ?>  
                                    />	
									<span class="pnfpb_slider round"></span>
							</label>								
							<button type="button" 
                                class="pnfpb_buddypress_follow_button" 
						...
						<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_padding_top_8 pnfpb_max_width_236" 
							   for="pnfpb_ic_fcm_buddypress_follow_enable">
							<?php echo esc_html(
	__("(requires BuddyPress Follow plugin)", "push-notification-for-post-and-buddypress")
); ?>
						</label>						
					</div>
					<div class="pnfpb_ic_buddypress_follow_form pnfpb_column_400">
						<label class="pnfpb_ic_push_settings_table_label_checkbox" 
							for="pnfpb_ic_fcm_buddypress_buddypress_follow_text_enable">
								<?php echo esc_html(
									__(
										"BuddyPress follow notification title (requires BuddyPress Follow plugin)",
										"push-notification-for-post-and-buddypress"
									)
								); ?>
						</label>
						...
						<input  class="pnfpb_ic_push_settings_table_value_column_input_field" 
								...
								type="text" value="<?php if (
									get_option("pnfpb_ic_fcm_buddypress_buddypress_follow_text_enable")
								) {
									echo esc_attr(
										get_option("pnfpb_ic_fcm_buddypress_buddypress_follow_text_enable")
									);
						...
						<p>
							...
							<?php echo esc_html(
								__(
									"is shortcode which replaces with follower name who followed you",
									"push-notification-for-post-and-buddypress"
								)
							); ?>
						</p>
						<br/>
						<label class="pnfpb_ic_push_settings_table_label_checkbox" 
							for="pnfpb_ic_fcm_buddypress_buddypress_follow_content_enable">
								<?php echo esc_html(
									__(
										"Default content for BuddyPress follow notification",
										"push-notification-for-post-and-buddypress"
									)
								); ?>
						</label>
