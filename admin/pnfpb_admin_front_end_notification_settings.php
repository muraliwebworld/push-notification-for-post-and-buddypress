...
<form action="options.php" method="post" enctype="multipart/form-data" class="form-field">
   ...
   foreach ($pnfpb_custposttypes as $pnfpb_post_type) {
       if ($pnfpb_post_type !== "buddypress" && $pnfpb_post_type !== "post") { ?>		
						<tr class="pnfpb_ic_push_settings_table_row">
    						<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
								<label for="<?php echo esc_attr("pnfpb_ic_fcm_frontend_settings_".$pnfpb_post_type."_button_text"); ?>">
									<?php echo esc_html(
    									__(
								...
								<br/>
								<input class="pnfpb_ic_push_settings_table_value_column_input_field"  
									   id="<?php echo esc_attr("pnfpb_ic_fcm_frontend_settings_".$pnfpb_post_type."_text"); ?>_text" 
									   name="<?php echo esc_attr("pnfpb_ic_fcm_frontend_settings_".$pnfpb_post_type."_text"); ?>"
									    type="text" 
									   value="<?php if (
    										get_option("pnfpb_ic_fcm_frontend_settings_" . $pnfpb_post_type . "_text")
										) {
   ...
   ?>
			...
			<tr class="pnfpb_ic_push_settings_table_row">
    			<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
					<label for="pnfpb_ic_fcm_frontend_settings_followers_text">
						<?php echo esc_html(
           					__(
               					"Subscription text for BP Followers",
               					"push-notification-for-post-and-buddypress"
           					)
       					); ?>
					</label>
					...
					<input class="pnfpb_ic_push_settings_table_value_column_input_field"  
						   ...
						   type="text" 
						   value="<?php if (
    								get_option("pnfpb_ic_fcm_frontend_settings_followers_text")
								) {
    								echo esc_attr(
        								get_option("pnfpb_ic_fcm_frontend_settings_followers_text")
    								);
