...
if (!class_exists("PNFPB_ICFM_admin_bar_menu_class")) {
    class PNFPB_ICFM_admin_bar_menu_class
    {
         ...
         * @param WP_Admin_Bar $wp_admin_bar WordPress Admin Bar object.
         */
        public function pnfpb_admin_push_settings_menu(
            WP_Admin_Bar $wp_admin_bar
        ) {
            $wp_admin_bar->add_menu([
         ...
         * @param WP_Admin_Bar $wp_admin_bar WordPress Admin Bar object.
         */
        public function pnfpb_admin_send_push_notification_menu(
            WP_Admin_Bar $wp_admin_bar
        ) {
            $wp_admin_bar->add_menu([
                "parent" => "pnfpb-ic-fcm-main-menu",
                ...
                "href" => admin_url(
                    "admin.php?page=pnfpb_icfmtest_notification"
                ),
            ]);
        }
        ...
        public function pnfpb_admin_pwa_menu(WP_Admin_Bar $wp_admin_bar)
        {
            $wp_admin_bar->add_menu([
                ...
                "href" => admin_url(
                    "admin.php?page=pnfpb_icfm_pwa_app_settings"
                ),
            ]);
        }
    }
