...
<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html(
    __("PNFPB - Customize Shortcode options", "push-notification-for-post-and-buddypress")
); ?></h1>
<?php
...
<div class="pnfpb_column_1200">
	<form action="options.php" method="post" enctype="multipart/form-data" class="form-field">
		...
		<div class="pnfpb_column_full">
			<ul class="pnfpb_ic_push_settings_header">
				<li>
					<h3>
						<?php echo esc_html(
			__(
				"Subscribe push notification bell-icon shortcode [subscribe_PNFPB_push_notification]",
				...
				<li>
					<h3>
						<?php echo esc_html(
			__(
				"PWA install shortcode [PNFPB_PWA_PROMPT] ",
				"push-notification-for-post-and-buddypress"
			)
	); ?>						
					</h3>
				...
				<tr class="pnfpb_ic_push_settings_table_row">
					<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
						<h3 class="pnfpb_ic_push_settings_header">
							<?php echo esc_html(
								__(
									"Settings for Push notification subscription bell icon shortcode [subscribe_PNFPB_push_notification]",
									"push-notification-for-post-and-buddypress"
								)
							); ?>
						</h3>
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">							
										<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_padding_top_8" 
											   for="pnfpb_shortcode_installed">
											<?php echo esc_html(
		__(
			"Enable when shortcode installed in single page/post",
			"push-notification-for-post-and-buddypress"
		)
	); ?>
										</label>												
										<label class="pnfpb_switch">
											<input  id="pnfpb_shortcode_installed" 
												   name="pnfpb_shortcode_installed" 
												   type="checkbox" value="1" <?php if (get_option("pnfpb_shortcode_installed", "0") === "1") {echo esc_attr("checked");} ?>  
												   />
				...
				"push-notification-for-post-and-buddypress"
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">							
										<p><?php echo esc_html(
		__(
			"Label text for shortcode (appear below bell icon)",
			"push-notification-for-post-and-buddypress"
		)
	); ?></p>
										<input  class="pnfpb_ic_push_settings_table_value_column_input_field" 
											   id="pnfpb_ic_fcm_label_text_shortcode" name="pnfpb_ic_fcm_label_text_shortcode" 
											   type="text" 
											   value="<?php if (
		get_option("pnfpb_ic_fcm_label_text_shortcode")
	) {
		echo esc_attr(
			get_option("pnfpb_ic_fcm_label_text_shortcode")
		);
				...
				"push-notification-for-post-and-buddypress"
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">							
										<p><?php echo esc_html(
		__(
			"Choose Position of popup after clicking on bell icon",
			"push-notification-for-post-and-buddypress"
		)
	); ?>
										</p>
											<div class="pnfpb-push-msg-model-column-shortcode pnfpb_margin_top_6">
												<div class="pnfpb-push-msg-model-prompt-button-container">
													<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container pnfpb_margin_left_4 pnfpb_margin_top_6 pnfpb_padding_top_8">
														<?php echo esc_html(
																__("Center of mobile/desktop screen", "push-notification-for-post-and-buddypress")
														); ?>
														<input  id="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   ...
															   value="1" <?php checked(
																	"1",
																	get_option("pnfpb_ic_fcm_bellicon_shortcode_style")
																	); ?>  
														/>
											...
											<div class="pnfpb-push-msg-model-column-shortcode pnfpb_margin_top_6">
												<div class="pnfpb-push-msg-model-prompt-button-container">
													<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container pnfpb_margin_left_4 pnfpb_margin_top_6 pnfpb_padding_top_8">
														<?php echo esc_html(
																__("Top of icon", "push-notification-for-post-and-buddypress")
														); ?>
														<input  id="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   name="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   type="radio" 
											...
											<div class="pnfpb-push-msg-model-column-shortcode pnfpb_margin_top_6">
												<div class="pnfpb-push-msg-model-prompt-button-container">
													<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container pnfpb_margin_left_4 pnfpb_margin_top_6 pnfpb_padding_top_8">
														<?php echo esc_html(
																__("Bottom of icon", "push-notification-for-post-and-buddypress")
														); ?>
														<input  id="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   name="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   type="radio" 
											...
											<div class="pnfpb-push-msg-model-column-shortcode pnfpb_margin_top_6">
												<div class="pnfpb-push-msg-model-prompt-button-container">
													<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container pnfpb_margin_left_4 pnfpb_padding_top_8">
														<?php echo esc_html(
																__("Left of icon", "push-notification-for-post-and-buddypress")
														); ?>
														<input  id="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   name="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   type="radio" 
											...
											<div class="pnfpb-push-msg-model-column-shortcode pnfpb_margin_top_6">
												<div class="pnfpb-push-msg-model-prompt-button-container">
													<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_container pnfpb_margin_left_4 pnfpb_padding_top_8" >
														<?php echo esc_html(
																__("Right of icon", "push-notification-for-post-and-buddypress")
														); ?>
														<input  id="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   name="pnfpb_ic_fcm_bellicon_shortcode_style" 
															   type="radio" 
		...
		echo esc_attr("checked");
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
										<label 
											   for="<?php echo esc_attr( "pnfpb_bell_icon_subscription_option_". $pnfpb_post_type."_text"); ?>">
											<?php echo esc_html(
										__(
											"Customize text for subscription ",
											"push-notification-for-post-and-buddypress"
										)
									) .	esc_html($pnfpb_post_type); ?>
										</label>
										<br/>
										<input class="pnfpb_ic_push_settings_table_value_column_input_field"  
											   ...
											   type="text" 
											   value="<?php if (
										get_option("pnfpb_bell_icon_subscription_option_" . $pnfpb_post_type . "_text_shortcode")
									) {
										echo esc_attr(
											get_option("pnfpb_bell_icon_subscription_option_" . $pnfpb_post_type . "_text_shortcode")
										);
									} else {
										echo esc_attr(ucwords($pnfpb_post_type));
									} 
													  ?>" 
											   />
									</td>
				   ...
				   ?>
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
										<label for="pnfpb_bell_icon_subscription_option_favourite_text_shortcode">
											<?php echo esc_html(
												__(
													"Subscribe text for Likes/Mark as favourite option in shortcode",
													"push-notification-for-post-and-buddypress"
												)
											); ?>
										</label>
										<br/>
										<input class="pnfpb_ic_push_settings_table_value_column_input_field"  id="pnfpb_bell_icon_subscription_option_favourite_text_shortcode" 
											   name="pnfpb_bell_icon_subscription_option_favourite_text_shortcode" type="text" 
											   value="<?php if (
															get_option("pnfpb_bell_icon_subscription_option_favourite_text_shortcode")
														) {
								...
								<tr class="pnfpb_ic_push_settings_table_row">
									<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
										<label for="pnfpb_bell_icon_subscription_option_followers_text_shortcode">
											<?php echo esc_html(
												__(
													"Subscribe text for BP Followers option in shortcode",
													"push-notification-for-post-and-buddypress"
												)
											); ?>
										</label>
										<br/>
										<input class="pnfpb_ic_push_settings_table_value_column_input_field"  id="pnfpb_bell_icon_subscription_option_followers_text_shortcode" 
											   name="pnfpb_bell_icon_subscription_option_followers_text_shortcode" type="text" 
											   value="<?php if (
															get_option("pnfpb_bell_icon_subscription_option_followers_text_shortcode")
														) {
