...
<h1 class="pnfpb_ic_push_settings_header"><?php echo esc_html(
    __(
        "PNFPB - PWA (Progressive Web App) settings",
...
<div class="pnfpb_column_1200">
 ...
 ?>
	...
	<h2 class="pnfpb_ic_push_pwa_settings_header2">
		<?php echo esc_html(
     		__(
          		"PNFPB - Progressive Web App(PWA) settings (or) Integrate with Progressier PWA",
          		"push-notification-for-post-and-buddypress"
      		)
  		); ?>
	</h2>
	...
	<div class="nav-tab-wrapper pnfpb-pwa-category-tabs" id="pnfpb-pwa-category-tabs">
		<a class="nav-tab nav-tab-active" id="pnfpb-pwa-native-tab" href="#pnfpb-pwa-native-tab-name">
			<?php echo esc_html(
      		__("PNFPB PWA settings", "push-notification-for-post-and-buddypress")
  			); ?>
		</a>
		<a class="nav-tab" id="pnfpb-pwa-other-tab" href="#pnfpb-pwa-other-tab-name">
			<?php echo esc_html(
     			__(
          			"Integrate with SuperPWA & Other PWA plugins",
          			"push-notification-for-post-and-buddypress"
      			)
  			); ?>
		</a>		
		<a class="nav-tab" id="pnfpb-pwa-thirdparty-tab" href="#pnfpb-pwa-thirdparty-tab-name">
			<?php echo esc_html(
     			__(
          			"Integrate with Progressier PWA",
          			"push-notification-for-post-and-buddypress"
      			)
  			); ?>
		</a>
	...
	<div id="pnfpb-pwa-native-tab-name" class="pnfpb-native-pwa-settings-tab pnfpb-category-pwa-settings-tab active">
		...
		<table id="pnfpb-pwa-tabs" class="pnfpb_ic_push_settings_table widefat fixed">
    		<tbody>
				<tr class="pnfpb_ic_push_settings_table_row">
					<td>
						<ul>
							<li class="pnfpb-admin-right_sidebar">
								<b>
								<?php echo esc_html(
               								__(
							...
							<b>
								<?php echo	esc_html(
               						__(
                   						"For Apple ios devices, PWA compatiable from ios 17.0 version onwards",
                   						"push-notification-for-post-and-buddypress"
               						)
           						); ?>
							</b>
  							...
  							<div class="pnfpb_column">
    							<div class="pnfpb_card">				
									...
									<label class="pnfpb_switch">
										<input  id="pnfpb_ic_pwa_app_enable" name="pnfpb_ic_pwa_app_enable" 
											   type="checkbox" value="1" <?php checked(
              										"1",
              										esc_attr(get_option("pnfpb_ic_pwa_app_enable"))
          										); ?>  
										/>	
		...
		<div class="nav-tab-wrapper pnfpb-pwa-tabs" id="pnfpb-pwa-tabs">
        	...
        	<a class="nav-tab" id="pnfpb-pwa-display-tab" href="#pnfpb-pwa-display">
				...
				<?php echo esc_html(
              		__("Icons", "push-notification-for-post-and-buddypress")
          		); ?>
			</a>
        	<a class="nav-tab" id="pnfpb-pwa-screenshot-tab" href="#pnfpb-pwa-screenshots">
				<?php echo esc_html(
             		__("Screenshots", "push-notification-for-post-and-buddypress")
         		); ?>
			</a>
        	...
        	<a class="nav-tab" id="pnfpb-pwa-offline-cache-tab" href="#pnfpb-pwa-cache">
				<?php echo esc_html(
             		__("Cache", "push-notification-for-post-and-buddypress")
         		); ?>
			</a>
        	<a class="nav-tab" id="pnfpb-pwa-custom-prompt-tab" href="#pnfpb-pwa-custom-prompt">
				<?php echo esc_html(
             		__("Custom Prompt", "push-notification-for-post-and-buddypress")
         		); ?>
			</a>
			...
			<a class="nav-tab" id="pnfpb-pwa-ios-devices-tab" href="#pnfpb-pwa-ios-devices">
				<?php echo esc_html(
       				__("ios iphone/ipad", "push-notification-for-post-and-buddypress")
   				); ?>
			</a>
			<a class="nav-tab" id="pnfpb-pwa-shortcode-tab" href="#pnfpb-pwa-shortcode">
				<?php echo esc_html(
       				__("Shortcode", "push-notification-for-post-and-buddypress")
   				); ?>
			</a>
    	</div>					
    	<div id="pnfpb-pwa-name" class="pnfpb-pwa-settings-tab active">
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<br/>
				<input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_pwa_app_name" 
					   name="pnfpb_ic_pwa_app_name" type="text" maxlength="50" 
					   value="<?php if (
        						get_option("pnfpb_ic_pwa_app_name")
   							 ) {
        						echo esc_attr(get_option("pnfpb_ic_pwa_app_name"));
    						} else {
        						echo esc_attr(substr(get_bloginfo("name"), 0, 50));
    						} ?>" required="required" 
				/>					
			</div>
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<br/>
				<input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_pwa_app_shortname" 
					   name="pnfpb_ic_pwa_app_shortname" type="text" maxlength="25" 
					   value="<?php if (
        							get_option("pnfpb_ic_pwa_app_shortname")
    							) {
        							echo esc_attr(get_option("pnfpb_ic_pwa_app_shortname"));
    							} else {
        							echo esc_attr(substr(get_bloginfo("name"), 0, 25));
    							} ?>" required="required" 
				/>					
			</div>
       		<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
    	...
    	<div id="pnfpb-pwa-display" class="pnfpb-pwa-settings-tab">
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<input class="pnfpb_ic_push_settings_table_value_column_input_field pnfpb_ic_push_pwa_color" 
					   id="pnfpb_ic_pwa_theme_color" name="pnfpb_ic_pwa_theme_color" type="color" 
					   value="<?php if (
        						get_option("pnfpb_ic_pwa_theme_color")
    						) {
        						echo esc_attr(get_option("pnfpb_ic_pwa_theme_color"));
    						} else {
        						echo esc_attr("#161515");
    						} ?>" required="required" 
				/>					
			</div>
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<input class="pnfpb_ic_push_settings_table_value_column_input_field pnfpb_ic_push_pwa_color" id="pnfpb_ic_pwa_app_backgroundcolor" 
					   name="pnfpb_ic_pwa_app_backgroundcolor" type="color" 
					   value="<?php if (
        							get_option("pnfpb_ic_pwa_app_backgroundcolor")
    							) {
        							echo esc_attr(get_option("pnfpb_ic_pwa_app_backgroundcolor"));
    							} else {
    		...
    		<div class="pnfpb_ic_push_settings_table_row">				
        		<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
					...
					<select name="pnfpb_ic_pwa_app_display" id="pnfpb_ic_pwa_app_display" required="required">
						<option value="standalone" <?php if (
          						get_option("pnfpb_ic_pwa_app_display") === "standalone"
      						) {
          						echo esc_attr("selected");
      						} else {
          						echo esc_attr("");
						...
						><?php echo esc_attr(
    							__("standalone", "push-notification-for-post-and-buddypress")
							); ?>
						</option>
						<option value="fullscreen" <?php if (
          						get_option("pnfpb_ic_pwa_app_display") === "fullscreen"
      						) {
         					 	echo esc_attr("selected");
      						} else {
          						echo esc_attr("");
						...
						><?php echo esc_html(
    							__("fullscreen", "push-notification-for-post-and-buddypress")
							); ?>
						</option>
						<option value="minimal-ui" <?php if (
          						get_option("pnfpb_ic_pwa_app_display") === "minimal-ui"
      						) {
          						echo esc_attr("selected");
      						} else {
          						echo esc_attr("");
							...
							<?php echo esc_html(
    							__("minimal-ui", "push-notification-for-post-and-buddypress")
							); ?>
						</option>
					</select>					
				</div>
		...
		<div id="pnfpb-pwa-icons" class="pnfpb-pwa-settings-tab">
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<?php echo esc_html(
        			__(
            			"PWA icon (icon1 - 132x132px and icon2 - 512x512px)",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</div>
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<div class="">
            		<table>
                       ...
                       ); ?>" id="pnfpb_ic_fcm_pwa_upload_button_132" class="pnfpb_ic_push_pwa_settings_upload_icon" />
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_icon_132" name="pnfpb_ic_fcm_pwa_upload_icon_132" value="<?php if (
                           get_option("pnfpb_ic_fcm_pwa_upload_icon_132")
                       ) {
                           echo esc_attr(
                               get_option("pnfpb_ic_fcm_pwa_upload_icon_132")
                           );
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div id="pnfpb_ic_fcm_pwa_upload_preview_132" style="background-image: url(<?php if (
                               get_option("pnfpb_ic_fcm_pwa_upload_icon_132")
                           ) {
                               echo esc_attr(
                                   get_option(
            		...
            		<table>
						...
						<tr>
							<td class="column-columnname">												
								...
								id="pnfpb_ic_fcm_pwa_upload_button_512" class="pnfpb_ic_push_pwa_settings_upload_icon" />
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_icon_512" 
									   name="pnfpb_ic_fcm_pwa_upload_icon_512" 
									   value="<?php if (
                           						get_option("pnfpb_ic_fcm_pwa_upload_icon_512")
                       						) {
                           						echo esc_attr(
                               						get_option("pnfpb_ic_fcm_pwa_upload_icon_512")
                           						);
                           						...
                           						echo esc_attr(
                               						plugin_dir_url(__DIR__) . "public/img/icon.png"
                           						);
                       						} ?>" 
								/>
                			</td>
						...
						<tr>
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div id="pnfpb_ic_fcm_pwa_upload_preview_512" style="background-image: url(<?php if (
                               			get_option("pnfpb_ic_fcm_pwa_upload_icon_512")
                           				) {
                               				echo esc_attr(
                                   				get_option(
		...
		<div id="pnfpb-pwa-screenshots" class="pnfpb-pwa-settings-tab">
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<?php echo esc_html(
        			__(
            			"Upload Screenshot of Desktop version of site and Screenshot of Mobile version of site.",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</div>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_attr(
                           			__(
                               			"Upload screenshot of Desktop version of site",
                               			"push-notification-for-post-and-buddypress"
                           			)
                       			); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_screenshot_desktop" 
									   class="pnfpb_ic_fcm_pwa_upload_screenshot_desktop" 
								/>
                    			<input type="hidden" 
							...
							<td  class="column-columnname">
        						<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
									<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop_label">
										<?php echo esc_html(
              								__(
                  								"Label for desktop screenshot",
                  								"push-notification-for-post-and-buddypress"
              								)
          								); ?>
									</label>
									<br/>
									<input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_fcm_pwa_upload_screenshot_desktop_label" 
										   ...
										   type="text" value="<?php if (
             										...
             										echo esc_attr("Homescreen of Awesome App");
         										} ?>" required="required" 
									/>					
								</div>
							</td>
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_mobile">
									<?php echo esc_html(
             							__(
                 							"PWA Mobile Screenshot ( mobile version of site)",
                 							"push-notification-for-post-and-buddypress"
             							)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           					__(
                               					"Upload screenshot of Mobile version of site",
                               					"push-notification-for-post-and-buddypress"
                           					)
                       					); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_screenshot_mobile" 
									   class="pnfpb_ic_fcm_pwa_upload_screenshot_mobile" 
								/>
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_screenshot_mobile_value" 
        						...
        						<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
									...
									<input class="pnfpb_ic_push_settings_table_value_column_input_field" 
										   ...
										   type="text" value="<?php if (
             										...
             										echo esc_attr("List of Awesome Resources available in Awesome App");
         										} ?>" required="required" 
										/>					
								</div>
							</td>
		...
		<div id="pnfpb-pwa-splashscreen-ios" class="pnfpb-pwa-settings-tab">
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<?php echo esc_html(
        			__(
            			"Splash screen for Apple macos,ios devices",
            			"push-notification-for-post-and-buddypress"
       			 	)
    			); ?>
			</div>
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             							__(
                 							"Splash screen icon for devices with 640x1136px",
                 							"push-notification-for-post-and-buddypress"
             							)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           				__(
                               				"Upload Splash screen icon in size 640x1136px",
                               				"push-notification-for-post-and-buddypress"
                           				)
                       				); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136" 
								/>
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_640_1136_value" 
									   value="<?php if (
                           							get_option(
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             							__(
                 							"Splash screen icon in size 750x1294px",
                 							"push-notification-for-post-and-buddypress"
             							)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           				__(
                               				"Upload Splash screen icon in size 750x1294px",
                               				"push-notification-for-post-and-buddypress"
                           				)
                       				); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294" 
								/>
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value" value="<?php if (
                           					get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div id="pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value_preview" 
										 style="background-image: url(<?php if (
                               						get_option(
                                   						"pnfpb_ic_fcm_pwa_upload_splashscreen_750_1294_value"
                               						)
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             							__(
                 							"Splash screen icon in size 1242x2148px",
                 							"push-notification-for-post-and-buddypress"
             							)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           			__(
                               			"Upload Splash screen icon in size 1242x2148px",
                               			"push-notification-for-post-and-buddypress"
                           			)
                       			); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148" 
								/>
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value" 
									   value="<?php if (
                           						get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div 
										 id="pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value_preview" 
										 style="background-image: url(<?php if (
                               					get_option(
                                   					"pnfpb_ic_fcm_pwa_upload_splashscreen_1242_2148_value"
                               					)
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             								__(
                 								"Splash screen icon in size 1125x2436px",
                 								"push-notification-for-post-and-buddypress"
             								)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           				__(
                               				"Upload Splash screen icon in size 1125x2436px",
                               				"push-notification-for-post-and-buddypress"
                           				)
                       				); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436" 
								/>
                    			<input type="hidden" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value" 
									   value="<?php if (
                           						get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div 
										 id="pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value_preview" 
										 style="background-image: url(<?php if (
                               						get_option(
                                   						"pnfpb_ic_fcm_pwa_upload_splashscreen_1125_2436_value"
                               						)
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             							__(
                 							"Splash screen icon in size 1536x2048px",
                 							"push-notification-for-post-and-buddypress"
            								)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           				__(
                               				"Upload Splash screen icon in size 1536x2048px",
                               				"push-notification-for-post-and-buddypress"
                           				)
                       				); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048" 
								/>
                    			<input type="hidden" id="pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value" 
									   value="<?php if (
                           							get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div 
										 id="pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value_preview" 
										 style="background-image: url(<?php if (
                               						get_option(
                                   						"pnfpb_ic_fcm_pwa_upload_splashscreen_1536_2048_value"
                               						)
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             								__(
                 								"Splash screen icon in size 1668x2224px",
                 								"push-notification-for-post-and-buddypress"
             								)
         								); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           				__(
                               				"Upload Splash screen icon in size 1668x2224px",
                               				"push-notification-for-post-and-buddypress"
                           				)
                       			); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224" 
								/>
                    			<input type="hidden" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value" 
									   value="<?php if (
                           							get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div 
										 id="pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value_preview" 
										 style="background-image: url(<?php if (
                               						get_option(
                                   						"pnfpb_ic_fcm_pwa_upload_splashscreen_1668_2224_value"
                               						)
            		...
            		<table class="pnfpb_pwa_table">
						<tr>
                			<td class="column-columnname">
								<label for="pnfpb_ic_fcm_pwa_upload_screenshot_desktop">
									<?php echo esc_html(
             							__(
                 							"Splash screen icon in size 2048x2732px",
                 							"push-notification-for-post-and-buddypress"
             							)
         							); ?>
								</label>
						...
						<tr>
							<td class="column-columnname">
                    			<input type="button" value="<?php echo esc_html(
                           			__(
                              			 "Upload Splash screen icon in size 2048x2732px",
                               			"push-notification-for-post-and-buddypress"
                           			)
                       			); ?>" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732" 
									   class="pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732" 
								/>
                    			<input type="hidden" 
									   id="pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value" 
									   name="pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value" 
									   value="<?php if (
                           						get_option(
						...
						<tr>							
                			<td class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
                    			<div style="display:block;width:100%; overflow:hidden; text-align:center;">
                        			<div 
										 id="pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value_preview" 
										 style="background-image: url(<?php if (
                               						get_option(
                                   						"pnfpb_ic_fcm_pwa_upload_splashscreen_2048_2732_value"
                               						)
		...
		<div id="pnfpb-pwa-cache" class="pnfpb-pwa-settings-tab">
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<?php echo "<b>" .
        			esc_html(
            			__(
               	 			"Below options are for offline facility for PWA - web app",
                			"push-notification-for-post-and-buddypress"
            			)
        			) .
        			"</b><br/><b>" .
        			esc_html(
            			__(
                			"Home page url to be cached for offline use(*required)",
                			"push-notification-for-post-and-buddypress"
            			)
        			) .
        		"</b>"; ?>	
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<select  id="pnfpb_ic_pwa_app_offline_url1" name="pnfpb_ic_pwa_app_offline_url1" required="required">
					<?php
     					$pnfpb_homeurlselected = "";
     					if (get_option("pnfpb_ic_pwa_app_offline_url1") === get_home_url()) {
         					$pnfpb_homeurlselected = "selected";
     					}
					
     					if ($pnfpb_pages = get_pages()) {
         						echo wp_kses('<option value="' .
             						esc_attr(get_home_url()) .
             						'"' .
             						esc_attr($pnfpb_homeurlselected) .
             						'">' .
             						esc_html(
                 						__("Home page", "push-notification-for-post-and-buddypress")
             						) .
             					'</option>',$pnfpb_allowed_html);
         					foreach ($pnfpb_pages as $pnfpb_page) {
             					echo wp_kses('<option value="' .
                 					esc_attr(get_page_link($pnfpb_page->ID)) .
                 					'" '.selected(esc_attr(get_page_link($pnfpb_page->ID)),get_option("pnfpb_ic_pwa_app_offline_url1"),false) .
                 					'>' .
                 					esc_html($pnfpb_page->post_title) .
                 				'</option>',$pnfpb_allowed_html);
         				}
     				}
     			?>
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<?php echo esc_html(
        				__(
            				"Default url for offline if page is not available in cache(*required)",
            				"push-notification-for-post-and-buddypress"
        				)
    			); ?>
			</div>
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<select id="pnfpb_ic_pwa_app_offline_url2" name="pnfpb_ic_pwa_app_offline_url2" required="required">
					<?php
     					...
     					if ($pnfpb_pages = get_pages()) {
         					echo wp_kses('<option value="' .
             					esc_attr(get_home_url().'"' .$pnfpb_homeurlselected) .
             					'>' .
             					esc_html(
                 					__("Home page", "push-notification-for-post-and-buddypress")
             					) .
         					...
         					foreach ($pnfpb_pages as $pnfpb_page) {
             					echo wp_kses('<option value="' .
                 					esc_attr(get_page_link($pnfpb_page->ID)) .
                 					'" '. selected(esc_attr(get_page_link($pnfpb_page->ID)),esc_attr(get_option("pnfpb_ic_pwa_app_offline_url2")),false) .
                 					'>' .
                 					esc_html($pnfpb_page->post_title) .
                 				'</option>',$pnfpb_allowed_html);
         					}
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<?php echo esc_html(
        				__(
            				"Other extra pages to be cached for offline use/to be stored in cache(Optional)",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</b>
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label for="pnfpb_ic_pwa_app_offline_url3">
					<?php echo esc_html(
         				__(
             				"website page url to be cached for offline",
             				"push-notification-for-post-and-buddypress"
         				)
     				); ?>
				</label>
				...
				<select id="pnfpb_ic_pwa_app_offline_url3" name="pnfpb_ic_pwa_app_offline_url3" >
					<?php if ($pnfpb_pages = get_pages()) { ?>
         				<option value="">Select page</option>
         				<?php foreach ($pnfpb_pages as $pnfpb_page) {
             				echo wp_kses('<option value="' .
                 					esc_attr(get_page_link($pnfpb_page->ID)) .
                 					'" ' .
                 					selected(
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<?php echo esc_html(
        			__(
            			"List of urls to be excluded from offline cache separted by comma. Please note that enter list of urls to be excluded separated with comma",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
				</b>
					...
					<div class="">
    					<div class="pnfpb_pwa_card">						
							<label class="pnfpb_ic_push_settings_table_label_checkbox">
								<?php echo esc_html(
            						__(
                						"Exclude all Urls from PWA offline cache",
                						"push-notification-for-post-and-buddypress"
            						)
        						); ?>
								<label class="pnfpb_switch">
									<input  id="pnfpb_ic_pwa_app_excludeallurls" name="pnfpb_ic_pwa_app_excludeallurls" 
										   type="checkbox" value="1" <?php checked(
             									"1",
             									esc_attr(get_option("pnfpb_ic_pwa_app_excludeallurls"))
         							); ?>  />
									<span class="pnfpb_slider round"></span>
								</label>
							</label>
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label for="pnfpb_ic_pwa_app_excludeurls">			
					<?php echo esc_html(
         				__(
             				"List of urls to be excluded from cache separated by comma",
             				"push-notification-for-post-and-buddypress"
         				)
     				); ?>
					<input class="pnfpb_ic_push_settings_table_value_column_input_field" 
						   id="pnfpb_ic_pwa_app_excludeurls" name="pnfpb_ic_pwa_app_excludeurls" 
						   type="text" value="<?php if (
         						get_option("pnfpb_ic_pwa_app_excludeurls")
     						) {
         						echo esc_url(get_option("pnfpb_ic_pwa_app_excludeurls"));
     						} ?>" 
					/>
				</label>
			</div>
		...
		<div id="pnfpb-pwa-custom-prompt" class="pnfpb-pwa-settings-tab">
    			...
    			<div class="pnfpb_pwa_card">
					...
					<label class="pnfpb_switch">
						<input  id="pnfpb_ic_pwa_app_custom_prompt_enable" 
							   name="pnfpb_ic_pwa_app_custom_prompt_enable" type="checkbox" 
							   value="1" <?php checked(
          							"1",
          							esc_attr(get_option("pnfpb_ic_pwa_app_custom_prompt_enable"))
      							); ?>  
						/>
						<span class="pnfpb_slider round"></span>
					</label>
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<div class="pnfpb_pwa_card">
					<label class="pnfpb_ic_push_pwa_custom_prompt_divider">
						<?php echo esc_html(
          					__(
              					"If cancelled, show custom prompt after number of days",
              					"push-notification-for-post-and-buddypress"
          					)
      					); ?>
					</label>
					<label>
						<input  class="pnfpb_ic_fcm_pwa_show_again_days" 
							   id="pnfpb_ic_fcm_pwa_show_again_days" name="pnfpb_ic_fcm_pwa_show_again_days" 
							   type="number" value="<?php if (
          							get_option("pnfpb_ic_fcm_pwa_show_again_days")
      							) {
          							echo esc_html(get_option("pnfpb_ic_fcm_pwa_show_again_days"));
      							} else {
          							echo "7";
      							} ?>"
						/>
				...
				<div class="pnfpb_pwa_card">
					...
					<label class="pnfpb_switch">
						<input  id="pnfpb_ic_pwa_app_desktop_custom_prompt_enable" 
							   name="pnfpb_ic_pwa_app_desktop_custom_prompt_enable" type="checkbox" 
							   value="1" <?php checked(
          							"1",
          							esc_attr(get_option("pnfpb_ic_pwa_app_desktop_custom_prompt_enable"))
      							); ?>  
						/>
						<span class="pnfpb_slider round"></span>
					</label>
   				...
   				<div class="pnfpb_pwa_card">
					...
					<label class="pnfpb_switch">
						<input  id="pnfpb_ic_pwa_app_mobile_custom_prompt_enable" 
							   name="pnfpb_ic_pwa_app_mobile_custom_prompt_enable" type="checkbox" 
							   value="1" <?php checked(
          							"1",
          							esc_attr(get_option("pnfpb_ic_pwa_app_mobile_custom_prompt_enable"))
      							); ?>  
						/>
						<span class="pnfpb_slider round"></span>
					</label>
   				...
   				<div class="pnfpb_pwa_card">
					...
					<label class="pnfpb_switch">
						<input  id="pnfpb_ic_pwa_app_pixels_custom_prompt_enable" 
							   ...
							   type="checkbox" value="1" <?php checked(
          							"1",
          							esc_attr(get_option("pnfpb_ic_pwa_app_pixels_custom_prompt_enable"))
      							); ?>  
						/>
						<span class="pnfpb_slider round"></span>									
					</label>
					<input  class="pnfpb_ic_push_settings_table_value_column_input_field 
						   ...
						   type="number" value="<?php if (
         							get_option("pnfpb_ic_pwa_app_pixels_input_custom_prompt_enable")
     							) {
         							echo esc_html(
             							get_option("pnfpb_ic_pwa_app_pixels_input_custom_prompt_enable")
         							);
					...
					<label>
						<?php echo esc_html(
         					__(" (in pixels)", "push-notification-for-post-and-buddypress")
     					); ?>
					</label>								
				</div>							
			</div>
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_fcm_pwa_prompt_text">
					<?php echo esc_html(
        				__(
				...
				<br/><br/>						
				<label for="pnfpb_ic_fcm_pwa_prompt_text">
					<?php echo esc_html(
        				__(
            				"Custom text to for PWA custom prompt",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				<br/>
				<input  class="pnfpb_ic_push_settings_table_value_column_input_field" 
					   id="pnfpb_ic_fcm_pwa_prompt_text" name="pnfpb_ic_fcm_pwa_prompt_text" 
					   type="text" value="<?php if (
        						get_option("pnfpb_ic_fcm_pwa_prompt_text")
    						) {
        						echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_text"));
    						} else {
        						echo esc_html(
            						__(
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt confirmation button text",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label><br/>	
				<input  class="pnfpb_ic_push_settings_table_value_column_input_field 
					   ...
					   name="pnfpb_ic_fcm_pwa_prompt_confirm_button" type="text" 
					   value="<?php if (
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt cancel button text",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				...
				<input  class="pnfpb_ic_push_settings_table_value_column_input_field 
					   ...
					   name="pnfpb_ic_fcm_pwa_prompt_cancel_button" type="text" 
					   value="<?php if (
        						get_option("pnfpb_ic_fcm_pwa_prompt_cancel_button")
    						) {
        						echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_cancel_button"));
    						} else {
        						echo esc_html(
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt Button background color",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				...
				<input class="pnfpb_ic_push_settings_table_value_column_input_field 
							  ...
							  pnfpb_ic_push_pwa_custom_prompt_divider" 
					   id="pnfpb_ic_fcm_pwa_prompt_button_background" name="pnfpb_ic_fcm_pwa_prompt_button_background" type="color" 
					   value="<?php if (
        							get_option("pnfpb_ic_fcm_pwa_prompt_button_background")
    							) {
        							echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_button_background"));
    							} else {
        							echo "#ffffff";
    							} ?>" required="required" 
				/>					
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt dialog box background color",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				...
				<input class="pnfpb_ic_push_settings_table_value_column_input_field 
					   ...
					   id="pnfpb_ic_fcm_pwa_prompt_dialog_background" name="pnfpb_ic_fcm_pwa_prompt_dialog_background" 
					   type="color" value="<?php if (
        						get_option("pnfpb_ic_fcm_pwa_prompt_dialog_background")
    						) {
        						echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_dialog_background"));
    						} else {
        						echo "#ffffff";
    						} ?>" required="required" 
				/>					
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt dialog Text color",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				...
				<input class="pnfpb_ic_push_settings_table_value_column_input_field 
					   ...
					   id="pnfpb_ic_fcm_pwa_prompt_text_color" name="pnfpb_ic_fcm_pwa_prompt_text_color" 
					   type="color" value="<?php if (
        								get_option("pnfpb_ic_fcm_pwa_prompt_text_color")
    								) {
        								echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_text_color"));
    								} else {
        								echo "#161515";
    								} ?>" required="required" 
				/>
				...
				<label>
					<?php echo esc_html(
        				__(
            				"PWA custom install prompt button Text color",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</label>
				<br/>
				<input class="pnfpb_ic_push_settings_table_value_column_input_field 
							  pnfpb_ic_fcm_pwa_prompt_button_text_color pnfpb_ic_push_pwa_custom_prompt_divider" 
					   id="pnfpb_ic_fcm_pwa_prompt_button_text_color" name="pnfpb_ic_fcm_pwa_prompt_button_text_color" 
					   type="color" value="<?php if (
        						get_option("pnfpb_ic_fcm_pwa_prompt_button_text_color")
    						) {
        						echo esc_html(get_option("pnfpb_ic_fcm_pwa_prompt_button_text_color"));
    						} else {
        						echo "#161515";
    					} ?>" required="required" 
				/>
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label for="pnfpb-pwa-dialog-app-installed_text">
					<?php echo esc_html(
         				__(
             				"PWA after installed confirmation popup header text",
             				"push-notification-for-post-and-buddypress"
         				)
     				); ?>
				</label>
				<br/>
				<input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb-pwa-dialog-app-installed_text" 
					   name="pnfpb-pwa-dialog-app-installed_text" 
					   type="text" maxlength="100" value="<?php if (
        						get_option("pnfpb-pwa-dialog-app-installed_text")
    						) {
        						echo esc_html(get_option("pnfpb-pwa-dialog-app-installed_text"));
    						} else {
        						echo esc_html(
            						__(
        	...
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label for="pnfpb-pwa-dialog-app-installed_text">
					<?php echo esc_html(
         				__(
             				"PWA after installed confirmation popup description",
             				"push-notification-for-post-and-buddypress"
         				)
     				); ?>
				</label>
				<br/>
				<input class="pnfpb_ic_push_settings_table_value_column_input_field" 
					   id="pnfpb-pwa-dialog-app-installed_description" name="pnfpb-pwa-dialog-app-installed_description" 
					   type="text" maxlength="500" value="<?php if (
        					get_option("pnfpb-pwa-dialog-app-installed_description")
    					) {
        					echo esc_html(get_option("pnfpb-pwa-dialog-app-installed_description"));
    					} else {
        					echo esc_html(
            					__(
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<?php echo esc_html(
        			__(
            			"All fields marked with '*' are required fields, Please verify before submitting the changes",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
				</b>
			...
			<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				...
				<?php echo esc_html(
        			__(
            			"Progressive Web Apps are supported by Chrome(Desktop,Mobile) browser, Edge browser, Firefox for android, Opera for android,Edge for Android, Brave for Android and Samsung Interent except Firefox for desktop",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
				</b>
    	...
    	<div id="pnfpb-pwa-protocol-handler" class="pnfpb-pwa-settings-tab">
        	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
				<label for="pnfpb_ic_pwa_protocol-name">
					...
					<br/>
					<a href="<?php echo esc_url("https://developer.mozilla.org/en-US/docs/Web/Manifest/protocol_handlers");?>" target="_blank">Help on Protocol Handler</a>
				</label>
			</div>
       						...
       						<div class="pnfpb_ic_pwa_protocol">
								<label class="pnfpb_ic_pwa_protocol-handler-element" for="pnfpb_ic_pwa_protocol-name">
									<?php echo 
          							...
          							<span>
										<b>
          									<?php echo esc_html(strval($pnfpb_pwa_protocol_count + 1)); ?>
										</b>
									</span>
								</label>
								<input type="button" name="pnfpb_ic_push_remove_protocol_button" 
									   id="pnfpb_ic_push_remove_protocol_button" class="button pnfpb_ic_push_remove_protocol_button" 
									   value="<?php echo esc_attr(
         									__("Delete", "push-notification-for-post-and-buddypress")
     									); ?>" 
								/>							
        						<div class="pnfpb_ic_push_pwa_settings_table_value_column 
											column-columnname pnfpb_pwa_card_protocol_root">
									<div class="pnfpb_ic_push_pwa_settings_table_value_column 
												column-columnname pnfpb_pwa_card_protocol_child">
										<label for="pnfpb_ic_pwa_protocol-name">
											<?php echo esc_html(
            									__("Protocol", "push-notification-for-post-and-buddypress")
        									); ?>
										...
										<input class="pnfpb_ic_push_settings_table_value_column_input_field" 
											   id="pnfpb_ic_pwa_protocol_name_<?php echo esc_html(
          											$pnfpb_pwa_protocol_count + 1
       											); ?>" 
											   name="pnfpb_ic_pwa_protocol_name[]" type="text" placeholder="web+jnglstore" 
											   value="<?php if (
    													trim($pnfpb_ic_pwa_protocol_name_array[$pnfpb_pwa_protocol_count]) != ""
													) {
    													echo esc_attr($pnfpb_ic_pwa_protocol_name_array[$pnfpb_pwa_protocol_count]);
													} ?>" 
										/>
								</div>
								<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname pnfpb_pwa_card_protocol_child">
									...
									<input class="pnfpb_ic_push_settings_table_value_column_input_field" 
										   id="<?php echo esc_attr("pnfpb_ic_pwa_protocol_url_".
           											$pnfpb_pwa_protocol_count + 1
       											); ?>" 
										   name="pnfpb_ic_pwa_protocol_url[]" type="text" 
										   placeholder="/shop?for=%s" 
										   value="<?php if (
    												trim($pnfpb_ic_pwa_protocol_url_array[$pnfpb_pwa_protocol_count]) != ""
												) {
    												echo esc_attr($pnfpb_ic_pwa_protocol_url_array[$pnfpb_pwa_protocol_count]);
												} ?>" 
									/>
						</div>
					</div>
				</div>
					<?php $pnfpb_pwa_protocol_count++;
				}
    		?>
			</div>
			<div class="pnfpb_ic_push_add_protocol_button_divider">
				<input type="button" name="pnfpb_ic_push_add_protocol_button" 
					   id="pnfpb_ic_push_add_protocol_button" class="button pnfpb_ic_push_add_protocol_button" 
					   value="Add protocol">
			</div>				
		</div>
		<div id="pnfpb-pwa-ios-devices" class="pnfpb-pwa-settings-tab">
			<ul>
				<li>
					<?php echo 
        				esc_html( __(
                				"Installation instructions for Apple devices iphone/ipad/macos",
                				"push-notification-for-post-and-buddypress"
            				)
        				) ; 
					?>
				...
				<li>
					<?php echo esc_html(
        				__(
            				"In phone/ipad browser, click on share icon in browser",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
			</li>
			<li>
				<?php echo esc_html(
        			__(
            			"Select add to home screen in ios devices or add to dock in macos",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</li>
			<li>
				<?php echo esc_html(
        			__(
            			"Same above instruction will be shown to frontend ios iphone/ipad device users using PWA custom prompt (when it is turned on) or when shortcode button is clicked by frontend ios device users",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</li>
			<li>
				<?php echo esc_html(
        			__(
            			"For ios devices(iphone/ipad), Push notification will work only thorugh PWA",
            			"push-notification-for-post-and-buddypress"
        			)
   				); ?>
			</li>
			<li>
				<?php echo esc_html(
        		__(
            		"For other devices macos,android,windows desktop, push notification will work normally",
            		"push-notification-for-post-and-buddypress"
        		)
    			); ?>
			</li>
			<li>
				<?php echo 
        			esc_html(
            			__(
                			"Shortcode [PNFPB_PWA_PROMPT] is available for PWA. When it is clicked on for ios devices, it will show above instruction. For other devices it will install PWA normally",
                			"push-notification-for-post-and-buddypress"
            			)
        			); ?>
			</li>					
	...
	echo "7";
			...
			<div>
				<label for="pnfpb-pwa-ios-message">
					<?php echo esc_html(
         				__(
             				"Customize PWA installation instruction for ios device users",
             				"push-notification-for-post-and-buddypress"
        				 )
     				); ?>
				</label>				
				<textarea class="pnfpb_ic_push_settings_table_value_column_input_field" 
						  id="pnfpb-pwa-ios-message" name="pnfpb-pwa-ios-message" 
						  type="text"  rows="3"><?php if (
        				get_option("pnfpb-pwa-ios-message")
    				) {
        				echo esc_textarea(get_option("pnfpb-pwa-ios-message"));
    				} else {
        				echo esc_textarea(
            				__(
			...
			<ul>
				<li>
					<a href="<?php echo esc_url(admin_url()."admin.php?page=pnfpb_icfm_button_settings#pwa-install-shortcode-customize-section"); ?>">
						<?php echo esc_html(
    						__(
        						"Customize PWA install shortcode button",
        						"push-notification-for-post-and-buddypress"
    						)
						); ?>
					</a>
		...
		<div id="pnfpb-pwa-shortcode" class="pnfpb-pwa-settings-tab">
			<ul>
				<li><b><?php echo 
        			esc_html(
            			__(
                			"Shortcode [PNFPB_PWA_PROMPT] is available to display PWA install button",
                			"push-notification-for-post-and-buddypress"
            			)
        			) ; ?>
				</b></li>
				<li>
					<?php echo esc_html(
        				__(
            				"If install button is clicked then it will display prompt to install Progressive Web App(PWA)",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</li>
				<li>
					<?php echo esc_html(
        				__(
            				"Once it is installed then PWA shortcode install button will not appear",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</li>
				<li>
					<?php echo esc_html(
        				__(
            				"PWA Shortcode install button will appear only when PWA is not installed",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</li>
				<li>
					<?php echo esc_html(
        				__(
            				"Customization options are available under customization tab",
            				"push-notification-for-post-and-buddypress"
        				)
    				); ?>
				</li>
	...
	<div id="pnfpb-pwa-other-tab-name" class="pnfpb-other-pwa-settings-tab pnfpb-category-pwa-settings-tab">
		<div id="pnfpb-other-pwa-tabs" class="pnfpb_ic_push_settings_table widefat fixed">
			<div class="pnfpb_row">
  				<div class="pnfpb_column">
    				<div class="pnfpb_card">				
						<label for="pnfpb_ic_other_pwa_app_enable"><?php echo esc_html(
          					__(
              					"Integrate PNFPB with other PWA plugins (like SuperPWA service worker file)",
              					"push-notification-for-post-and-buddypress"
          					)
      					); ?>
						</label>
						<label class="pnfpb_switch">
							<input  id="pnfpb_integrate_service_worker_in_another_plugin" name="pnfpb_integrate_service_worker_in_another_plugin" 
								   type="checkbox" value="1" <?php checked(
           								"1",
           								esc_attr(get_option("pnfpb_integrate_service_worker_in_another_plugin"))
       								); ?>  
							/>	
							<span class="pnfpb_slider round"></span>
						</label>
						<ul>
							<li>
								<label for="pnfpb_ic_other_pwa_app_enable"><?php echo esc_html(
          							__(
              							"If superpwa/other pwa plugins provides PNFPB integration then enable above option or it requires custom code as mentioned below in other PWA plugins",
              							"push-notification-for-post-and-buddypress"
          							)
      								); ?>
								</label>
							...
							<li>
								<label for="pnfpb_ic_other_pwa_app_enable"><?php echo esc_html(
          							__(
              							" Use below apply_filter command in your PWA plugin where service worker file generated, To merge PNFPB service worker code for push notification with other PWA plugins (like superpwa) service worker file to receive push notification",
              							"push-notification-for-post-and-buddypress"
          							)
      								); ?>
								</label>
							...
							<li>
								<b>
									<label for="pnfpb_ic_other_pwa_app_enable"><?php echo esc_html(
          								__(
              								"apply_filters('pnfpb_service_worker_extension', <plugincode variable containing PWA plugin's service worker code>)",
              								"push-notification-for-post-and-buddypress"
          								)
      									); ?>
									</label>
							...
							<li>
								<label for="pnfpb_ic_other_pwa_app_enable"><?php echo esc_html(
	__(
		"Following is an example showing PHP code to append PNFPB service worker code in superpwa plugin service worker file, so that BuddyPress push notifications will be received/displayed using superpwa plugin's service worker file. ( at the end of function superpwa_sw_template())",
		"push-notification-for-post-and-buddypress"
	)
); ?>
								</label>
							</li>
							<li><pre><code>$superpwa_sw_code = ob_get_clean();<br/>if (get_option("pnfpb_integrate_service_worker_in_another_plugin") === "1")<br/>{<br/>	$superpwa_sw_code = apply_filters( 'superpwa_sw_template', $superpwa_sw_code );<br/>	/* Integrate & merge from PNFPB service worker code for push notification */<br/>	return apply_filters('pnfpb_service_worker_extension', $superpwa_sw_code);<br/>	} else {<br/>	return apply_filters( 'superpwa_sw_template', $superpwa_sw_code );<br/>}
								</code>
							</pre>
							</li>
						</ul>
	...
	<div id="pnfpb-pwa-thirdparty-tab-name" class="pnfpb-thirdparty-pwa-settings-tab pnfpb-category-pwa-settings-tab">
		<div id="pnfpb-thirdparty-pwa-tabs" class="pnfpb_ic_push_settings_table widefat fixed">
			<div class="pnfpb_row">
  				<div class="pnfpb_column">
    				<div class="pnfpb_card">				
						<label for="pnfpb_ic_thirdparty_pwa_app_enable"><?php echo esc_html(
          					__(
              					"Enable/Disable Progressier PWA",
              					"push-notification-for-post-and-buddypress"
          					)
      					); ?>
						</label>
						<label class="pnfpb_switch">
							<input  id="pnfpb_ic_thirdparty_pwa_app_enable" name="pnfpb_ic_thirdparty_pwa_app_enable" 
								   type="checkbox" value="1" <?php checked(
           								"1",
           								esc_attr(get_option("pnfpb_ic_thirdparty_pwa_app_enable"))
       								); ?>  
							/>	
							<span class="pnfpb_slider round"></span>
						</label>
        ...
        <div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
			<label for="pnfpb_ic_pwa_thirdparty_app_id">
				<?php echo esc_html(
        			__(
            			"Enter Progressier app id (only app id, do not enter url)",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</label>
			<br/>
			<input class="pnfpb_ic_push_settings_table_value_column_input_field" id="pnfpb_ic_pwa_thirdparty_app_id" 
				   name="pnfpb_ic_pwa_thirdparty_app_id" type="text" maxlength="50" 
				   value="<?php if (
       							get_option("pnfpb_ic_pwa_thirdparty_app_id")
   							) {
       							echo esc_html(get_option("pnfpb_ic_pwa_thirdparty_app_id"));
   							} else {
       							echo esc_html(get_option("pnfpb_ic_pwa_thirdparty_app_id"));
   							} ?>" 
			/>
			...
			<label for="pnfpb_ic_pwa_thirdparty_app_id">
				<?php echo esc_html(
        			__(
            			"(example like https://progressier.app/appid/progressier.json, in this url, app id is in second qualifier)",
            			"push-notification-for-post-and-buddypress"
        			)
    			); ?>
			</label>			
	...
	<div class="pnfpb_ic_push_pwa_settings_table_value_column column-columnname">
		<div class="pnfpb_column_full_pwa">
			<?php submit_button(
